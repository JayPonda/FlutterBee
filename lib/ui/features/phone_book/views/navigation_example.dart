...
class NavigationExamplePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      navigationBar: CupertinoNavigationBar(
        ...
        trailing: _buildThemeToggleButton(context, themeProvider),
      ),
      child: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildThemeSelectorSection(context, themeProvider),
              ...
              _NavSection(
                ...
                onTap: () {
                  final contacts = viewModel.listsNotifier.value.isNotEmpty
                      ? viewModel.listsNotifier.value.first.contacts
                      : [];
                  if (contacts.isEmpty) {
  ...
  Widget _buildThemeSelectorSection(BuildContext context, ThemeProvider themeProvider) {
    return Container(
      padding: const EdgeInsets.all(12.0),
      decoration: BoxDecoration(
